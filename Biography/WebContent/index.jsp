...
<html>
<<head>
	<title>SOUMYA – Personal Portfolio</title>
...
<body>
	...
	<section id="home" class="tt-fullHeight" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
		<div class="intro">
			<div class="intro-sub">I am SOUMYA</div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-push-8">
            <div class="biography">
              ...
              <ul>
                <li><strong>Name:</strong> Soumya Kundu</li>
      ...
      <div class="tf-bg-overlay">
        ...
        <div class="container">
          ...
          <div class="video-intro">
             <a class="popup-video" href="https://www.youtube.com/watch?v=LGOjcu0HRec"> <i class="fa fa-play" style="padding-top: 15px;"></i>  </a>
	...
	<!-- Scroll-up -->
	<div class="scroll-up">
		<a href="#home"><i class="fa fa-angle-up" style="padding-top: 6px;"></i></a>
	</div>
